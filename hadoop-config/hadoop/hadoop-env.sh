...
#add spark on hive
#export HADOOP_CLASSPATH=$HADOOP_CLASSPATH:$HADOOP_HOME/lib/*:$HBASE_HOME/lib/*:/usr/local/spark-2.1.1-bin-hadoop2-without-hive/jars/*:/data/hainiu/hbase_split/*
export HADOOP_CLASSPATH=$HADOOP_CLASSPATH:$HADOOP_HOME/lib/*:$HBASE_HOME/lib/*:/data/hainiu/hbase_split/*
